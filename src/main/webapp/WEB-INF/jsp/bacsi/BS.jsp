...
<body>
	<header class="topnav nav nav-tabs" id="myTopnav">
        ...
        <div class="dropdown">
		    <a href="javascript:void(0)" class="dropbtn">Quản lý bệnh án</a>
        ...
        <a href="${pageContext.request.contextPath}/home/dangxuat.html" style="float:right">Đăng xuất</a>
    </header>
    ...
    <div class="container">
        <div class="tab-content">
        	...
        	<%if (request.getParameter("bs")!=null){ %>
		        ...
		        <%} else if (request.getParameter("bs").equals("health-records")){%>
		        	<jsp:include page="health-records.jsp"></jsp:include>
	        	<%} else if (request.getParameter("bs").equals("new-health-record")){%>
	        		<jsp:include page="new-health-record.jsp"></jsp:include>
